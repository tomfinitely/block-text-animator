...
Features:
* Multiple animation effects: typewriter, matrix scramble, fade, flash, burst, glitch
...
* Stable layout prevents content shifting during animations
...
* **Glitch**: VHS-style horizontal glitch with chromatic aberration
...
= 0.2.0 =
* Added Glitch animation with VHS-style effects and chromatic aberration
* Fixed layout stability to prevent content shifting during animations
* Improved multi-line text handling in animations
* Removed font overrides to respect theme typography
* Enhanced glitch transition smoothness
